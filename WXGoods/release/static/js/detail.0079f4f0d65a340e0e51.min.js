...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clipboardMin = __webpack_require__(141);
	...
	var env = 'product';exports.default = {
	    ...
	    created: function created() {
	        ...
	        var _vue = this;
	        _vue.$ajax.get(_envConfig2.default.getApi(env, "couponDetail") + "/" + this.$route.query.id).then(function (res) {
	            if (res.data.code == 0) {
	    ...
	    mounted: function mounted() {
	        ...
	        var _vue = this;
	        var clipboard = new _clipboardMin2.default('.btn');
	    }
	};
	...
	!function (a) {
	  ...
	  return function a(b, c, d) {
	    function e(g, h) {
	      ...
	      var d = a("closest"),
	          e = a("component-event"),
	          f = ["focus", "blur"];c.bind = function (a, b, c, g, h) {
	        return -1 !== f.indexOf(c) && (h = !0), e.bind(a, c, function (c) {
	          var e = c.target || c.srcElement;c.delegateTarget = d(e, b, !0, a), c.delegateTarget && g.call(a, c);
	        }, h);
	      ...
	      var d = window.addEventListener ? "addEventListener" : "attachEvent",
	          ...
	          f = "addEventListener" !== d ? "on" : "";c.bind = function (a, b, c, e) {
	      ...
	      function d(a, b) {
	        ...
	        function a(b) {
	          ...
	          var a = this;this.removeFake(), this.fakeHandler = document.body.addEventListener("click", function () {
	            return a.removeFake();
	          ...
	          if ("INPUT" === this.target.nodeName || "TEXTAREA" === this.target.nodeName) this.target.select(), this.selectedText = this.target.value;else {
	            var a = document.createRange(),
	                b = window.getSelection();a.selectNodeContents(this.target), b.addRange(a), this.selectedText = b.toString();
	          }this.copyText();
	          ...
	          this.target && this.target.blur(), window.getSelection().removeAllRanges();
	        }, e(a, [{ key: "action", set: function set() {
	            ...
	            if (void 0 !== a) {
	              if (!a || "object" != (typeof a === "undefined" ? "undefined" : (0, _typeof3.default)(a)) || 1 !== a.nodeType) throw new Error('Invalid "target" value, use a valid Element');this._target = a;
	            }
	          }, get: function get() {
	            return this._target;
	          } }]), a;
	      ...
	      function d(a) {
	      ...
	      }c.__esModule = !0;var g = a("./clipboard-action"),
	          h = d(g),
	          i = a("delegate-events"),
	          j = d(i),
	          k = a("tiny-emitter"),
	        ...
	        function b(c, d) {
	          ...
	          var a = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0];this.action = "function" == typeof a.action ? a.action : this.setAction, this.target = "function" == typeof a.target ? a.target : this.setTarget, this.text = "function" == typeof a.text ? a.text : this.setText;
	        }, b.prototype.delegateClick = function (a) {
	          var b = this;j["default"].bind(document.body, a, "click", function (a) {
	            return b.initialize(a);
	          });
	        }, b.prototype.initialize = function (a) {
	          this.clipboardAction && (this.clipboardAction = null), this.clipboardAction = new h["default"]({ action: this.action(a.delegateTarget), target: this.target(a.delegateTarget), text: this.text(a.delegateTarget), trigger: a.delegateTarget, emitter: this });
	          ...
	          if (a.hasAttribute(m + "target")) {
	            var b = a.getAttribute(m + "target");return document.querySelector(b);
	          }
	        }, b.prototype.setText = function (a) {
	          return a.hasAttribute(m + "text") ? a.getAttribute(m + "text") : void 0;
	        }, b;
	      }(l["default"]);c["default"] = n, b.exports = c["default"];
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(38)(Function.call, __webpack_require__(104).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.detail {\n  min-height: 100%;\n  background: #fff;\n  padding-bottom: 20px;\n}\n#detail_panel.detail_panel {\n  padding: 15px;\n  background: #fff;\n  color: #35353f;\n  font-size: 13px;\n  line-height: 25px;\n}\n#detail_panel.detail_panel img {\n  width: 100%;\n}\n#detail_panel.detail_panel .content {\n  position: relative;\n}\n#detail_panel.detail_panel .content .info {\n  float: left;\n}\n#detail_panel.detail_panel .header {\n  font-family: PingFang-SC-Regular !important;\n  color: #35353f;\n  font-size: 15px;\n}\n#detail_panel.detail_panel .price {\n  font-family: PingFang-SC-Medium !important;\n  font-size: 18px;\n  color: #fd472b;\n  width: 60%;\n  float: left;\n}\n#detail_panel.detail_panel .dicount {\n  font-size: 11px;\n  color: #90909b;\n}\n#detail_panel.detail_panel .num {\n  font-size: 11px;\n  color: #90909b;\n  margin-left: 22px;\n}\n#detail_panel.detail_panel .ticket-panel {\n  float: right;\n  width: 60px;\n  line-height: 15px;\n  height: 39px;\n  text-align: center;\n}\n#detail_panel.detail_panel .ticket-panel .amount {\n  font-family: PingFang-SC-Regular !important;\n  font-size: 10px;\n  border: 2px solid #fb8e00;\n  border-radius: 0px 0px 5px 5px;\n  background: #fb8e00;\n  color: #fff;\n}\n#detail_panel.detail_panel .ticket-panel .header {\n  color: #fb8e00;\n  font-family: PingFang-SC-Regular !important;\n  font-size: 10px;\n  border: 2px solid #fb8e00;\n  border-radius: 5px 5px 0px 0px;\n}\n.modal {\n  font-size: 15px;\n  position: fixed;\n  top: 45%;\n  width: 50%;\n  height: 75px;\n  text-align: center;\n  background: rgba(0, 0, 0, 0.53);\n  color: #fff;\n  padding: 30px;\n  /* margin: 0 20%; */\n  left: 25%;\n  border-radius: 5px;\n}\n.reason {\n  font-family: PingFang-SC-Regular;\n  padding: 10px 15px;\n  background: #fff;\n  color: #90909b;\n  font-size: 10px;\n  width: 100%;\n  float: left;\n  border-top: 1px dashed #dedede;\n  border-bottom: 5px solid #eee;\n}\n.opt_panel {\n  margin: 20px;\n  margin-bottom: 50px;\n  line-height: 23px;\n  font-family: PingFang-SC-Medium !important;\n  color: #fd472b;\n  font-size: 14px;\n  margin-top: 85px;\n  text-align: center;\n  border: 1px solid #dedede;\n  background: #fff;\n  position: relative;\n}\n.opt_panel span {\n  line-height: 13px;\n}\n.opt_panel .title {\n  color: #fd472b;\n  width: 60%;\n  position: absolute;\n  text-align: center;\n  left: 0px;\n  top: -8px;\n  background: #fff;\n  margin: 0 20%;\n}\n.tao {\n  font-size: 13px;\n  color: #333;\n}\n.footer {\n  position: fixed;\n  background: #fd472b;\n  bottom: 0px;\n  width: 100%;\n}\n.footer span {\n  color: #fff;\n  width: 100%;\n  text-align: center;\n  display: inline-block;\n  font-family: PingFang-SC-Medium !important;\n  font-size: 15px;\n  margin: 15px 0;\n}\n.footer span a {\n  color: #fff!important;\n}\n.footer button {\n  color: #fff;\n  background: #fd472b;\n  width: 100%;\n  text-align: center;\n  display: inline-block;\n  font-family: PingFang-SC-Medium !important;\n  font-size: 15px;\n  margin: 15px 0;\n}\n", "", {"version":3,"sources":["/./src/pages/detail/index.vue"],"names":[],"mappings":";AACA;EACE,iBAAiB;EACjB,iBAAiB;EACjB,qBAAqB;CACtB;AACD;EACE,cAAc;EACd,iBAAiB;EACjB,eAAe;EACf,gBAAgB;EAChB,kBAAkB;CACnB;AACD;EACE,YAAY;CACb;AACD;EACE,mBAAmB;CACpB;AACD;EACE,YAAY;CACb;AACD;EACE,4CAA4C;EAC5C,eAAe;EACf,gBAAgB;CACjB;AACD;EACE,2CAA2C;EAC3C,gBAAgB;EAChB,eAAe;EACf,WAAW;EACX,YAAY;CACb;AACD;EACE,gBAAgB;EAChB,eAAe;CAChB;AACD;EACE,gBAAgB;EAChB,eAAe;EACf,kBAAkB;CACnB;AACD;EACE,aAAa;EACb,YAAY;EACZ,kBAAkB;EAClB,aAAa;EACb,mBAAmB;CACpB;AACD;EACE,4CAA4C;EAC5C,gBAAgB;EAChB,0BAA0B;EAC1B,+BAA+B;EAC/B,oBAAoB;EACpB,YAAY;CACb;AACD;EACE,eAAe;EACf,4CAA4C;EAC5C,gBAAgB;EAChB,0BAA0B;EAC1B,+BAA+B;CAChC;AACD;EACE,gBAAgB;EAChB,gBAAgB;EAChB,SAAS;EACT,WAAW;EACX,aAAa;EACb,mBAAmB;EACnB,gCAAgC;EAChC,YAAY;EACZ,cAAc;EACd,oBAAoB;EACpB,UAAU;EACV,mBAAmB;CACpB;AACD;EACE,iCAAiC;EACjC,mBAAmB;EACnB,iBAAiB;EACjB,eAAe;EACf,gBAAgB;EAChB,YAAY;EACZ,YAAY;EACZ,+BAA+B;EAC/B,8BAA8B;CAC/B;AACD;EACE,aAAa;EACb,oBAAoB;EACpB,kBAAkB;EAClB,2CAA2C;EAC3C,eAAe;EACf,gBAAgB;EAChB,iBAAiB;EACjB,mBAAmB;EACnB,0BAA0B;EAC1B,iBAAiB;EACjB,mBAAmB;CACpB;AACD;EACE,kBAAkB;CACnB;AACD;EACE,eAAe;EACf,WAAW;EACX,mBAAmB;EACnB,mBAAmB;EACnB,UAAU;EACV,UAAU;EACV,iBAAiB;EACjB,cAAc;CACf;AACD;EACE,gBAAgB;EAChB,YAAY;CACb;AACD;EACE,gBAAgB;EAChB,oBAAoB;EACpB,YAAY;EACZ,YAAY;CACb;AACD;EACE,YAAY;EACZ,YAAY;EACZ,mBAAmB;EACnB,sBAAsB;EACtB,2CAA2C;EAC3C,gBAAgB;EAChB,eAAe;CAChB;AACD;EACE,sBAAsB;CACvB;AACD;EACE,YAAY;EACZ,oBAAoB;EACpB,YAAY;EACZ,mBAAmB;EACnB,sBAAsB;EACtB,2CAA2C;EAC3C,gBAAgB;EAChB,eAAe;CAChB","file":"index.vue","sourcesContent":["\n.detail {\n  min-height: 100%;\n  background: #fff;\n  padding-bottom: 20px;\n}\n#detail_panel.detail_panel {\n  padding: 15px;\n  background: #fff;\n  color: #35353f;\n  font-size: 13px;\n  line-height: 25px;\n}\n#detail_panel.detail_panel img {\n  width: 100%;\n}\n#detail_panel.detail_panel .content {\n  position: relative;\n}\n#detail_panel.detail_panel .content .info {\n  float: left;\n}\n#detail_panel.detail_panel .header {\n  font-family: PingFang-SC-Regular !important;\n  color: #35353f;\n  font-size: 15px;\n}\n#detail_panel.detail_panel .price {\n  font-family: PingFang-SC-Medium !important;\n  font-size: 18px;\n  color: #fd472b;\n  width: 60%;\n  float: left;\n}\n#detail_panel.detail_panel .dicount {\n  font-size: 11px;\n  color: #90909b;\n}\n#detail_panel.detail_panel .num {\n  font-size: 11px;\n  color: #90909b;\n  margin-left: 22px;\n}\n#detail_panel.detail_panel .ticket-panel {\n  float: right;\n  width: 60px;\n  line-height: 15px;\n  height: 39px;\n  text-align: center;\n}\n#detail_panel.detail_panel .ticket-panel .amount {\n  font-family: PingFang-SC-Regular !important;\n  font-size: 10px;\n  border: 2px solid #fb8e00;\n  border-radius: 0px 0px 5px 5px;\n  background: #fb8e00;\n  color: #fff;\n}\n#detail_panel.detail_panel .ticket-panel .header {\n  color: #fb8e00;\n  font-family: PingFang-SC-Regular !important;\n  font-size: 10px;\n  border: 2px solid #fb8e00;\n  border-radius: 5px 5px 0px 0px;\n}\n.modal {\n  font-size: 15px;\n  position: fixed;\n  top: 45%;\n  width: 50%;\n  height: 75px;\n  text-align: center;\n  background: rgba(0, 0, 0, 0.53);\n  color: #fff;\n  padding: 30px;\n  /* margin: 0 20%; */\n  left: 25%;\n  border-radius: 5px;\n}\n.reason {\n  font-family: PingFang-SC-Regular;\n  padding: 10px 15px;\n  background: #fff;\n  color: #90909b;\n  font-size: 10px;\n  width: 100%;\n  float: left;\n  border-top: 1px dashed #dedede;\n  border-bottom: 5px solid #eee;\n}\n.opt_panel {\n  margin: 20px;\n  margin-bottom: 50px;\n  line-height: 23px;\n  font-family: PingFang-SC-Medium !important;\n  color: #fd472b;\n  font-size: 14px;\n  margin-top: 85px;\n  text-align: center;\n  border: 1px solid #dedede;\n  background: #fff;\n  position: relative;\n}\n.opt_panel span {\n  line-height: 13px;\n}\n.opt_panel .title {\n  color: #fd472b;\n  width: 60%;\n  position: absolute;\n  text-align: center;\n  left: 0px;\n  top: -8px;\n  background: #fff;\n  margin: 0 20%;\n}\n.tao {\n  font-size: 13px;\n  color: #333;\n}\n.footer {\n  position: fixed;\n  background: #fd472b;\n  bottom: 0px;\n  width: 100%;\n}\n.footer span {\n  color: #fff;\n  width: 100%;\n  text-align: center;\n  display: inline-block;\n  font-family: PingFang-SC-Medium !important;\n  font-size: 15px;\n  margin: 15px 0;\n}\n.footer span a {\n  color: #fff!important;\n}\n.footer button {\n  color: #fff;\n  background: #fd472b;\n  width: 100%;\n  text-align: center;\n  display: inline-block;\n  font-family: PingFang-SC-Medium !important;\n  font-size: 15px;\n  margin: 15px 0;\n}\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._v("券后价:")]), _vm._v("￥" + _vm._s(_vm.price[0])), _c('font', {
	    staticStyle: {
	      "color": "#fd472b",
	      "font-size": "13px"
	    }
	  }, [_vm._v("." + _vm._s(_vm.price[1] == undefined ? '00' : _vm.price[1]))])], 1), _vm._v(" "), _c('div', {
	    staticClass: "ticket-panel"
	  }, [_c('div', {
	    staticClass: "header"
	  }, [_vm._v("包邮")]), _vm._v(" "), _c('div', {
	    staticClass: "amount"
	  }, [_vm._v(_vm._s(_vm.CouponPrice) + "元优惠券")])]), _vm._v(" "), _c('div', {
	    staticClass: "info"
	  }, [_c('span', {
	    staticClass: "dicount"
	  }, [_vm._v("在售价:" + _vm._s(_vm.discount))]), _vm._v(" "), _c('span', {
	    staticClass: "num"
	  }, [_vm._v("已售:" + _vm._s(_vm.num))])]), _vm._v(" "), _c('div', {
	    staticStyle: {
	      "clear": "both"
	    }
	  })])]), _vm._v(" "), _c('div', {
	    staticClass: "reason"
	  }, [_vm._v("推荐理由: " + _vm._s(_vm.reason))]), _vm._v(" "), (_vm.source != 'jd') ? _c('div', {
	    staticClass: "opt_panel"
	  }, [_c('span', {
	    staticClass: "title"
	  }, [_vm._v("长按框内>全选>复制")]), _vm._v(" "), _c('span', {
	    staticStyle: {
	      "text-align": "center",
	      "width": "100%",
	      "font-size": "13px",
	  ...
	  }, [_vm._v("打开「手机淘宝」即可「领取优惠券」并购买")]), _vm._v(" "), _c('span', {
	    staticClass: "tao",
	    attrs: {
	      "id": "tao"
	    }
	  }, [_vm._v(_vm._s(_vm.taoCode))])]) : _vm._e(), _vm._v(" "), _c('div', {
	    staticClass: "footer"
	  }, [(_vm.source != 'jd' && _vm.IosClient) ? _c('button', {
	    staticClass: "btn",
	    attrs: {
	      "data-clipboard-target": "#tao"
	    },
	    on: {
	      "click": _vm.copy
	    }
	  }, [_vm._v("一键复制")]) : _vm._e(), _vm._v(" "), (_vm.source != 'jd' && _vm.AndroidClient) ? _c('button', {
	    staticClass: "btn",
	    attrs: {
	      "data-clipboard-text": _vm.taoCode
	    },
	    on: {
	      "click": _vm.copy
	    }
	  }, [_vm._v("一键复制")]) : _vm._e(), _vm._v(" "), (_vm.source == 'jd') ? _c('a', {
	    attrs: {
	      "href": _vm.url
	    }
	  }, [_c('span', [_vm._v("立即购买")])]) : _vm._e()]), _vm._v(" "), _c('error-message', _vm._b({}, 'error-message', {
	    pastle: _vm.pastle,
	    message: _vm.message
	  }))], 1)
	},staticRenderFns: []}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-55775cc4!../../../node_modules/less-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-55775cc4!../../../node_modules/less-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
//# sourceMappingURL=detail.0079f4f0d65a340e0e51.min.js.map